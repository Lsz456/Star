...
<head>
    ...
    <title>星辰·动漫</title>
    <base href="<%=basePath%>" />
    <link rel="stylesheet" type="text/css" href="css/styleFuzzyQuery.css">
    ...
    <div class="box">
        ...
        <div class="anime">
            ...
            <div class="positive">
                ...
                %>
                <div class="videoPush">
                    <a id="img<%=i%>" href="film/video.com?name=<%=film.getF_id()%>">
                        <img id="images<%=i%>" class="images" src="<%=film.getF_images()%>">
                    </a>
...
<%--                    <span class="Score"><%=anime.getA_score()%></span>--%>
                    <a id="img<%=i%>" href="cartoon/video.com?name=<%=anime.getA_id()%>">
                        <img id="images<%=i%>" class="images" src="<%=anime.getA_image_url()%>">
                    </a>
                ...
                <div class="videoPush">
                    ...
                    <a id="img<%=i%>" href="teleplay/video.com?name=<%=tv.getT_id()%>">
                        <img id="images<%=i%>" class="images" src="<%=tv.getT_image_url()%>" >
                    </a>
